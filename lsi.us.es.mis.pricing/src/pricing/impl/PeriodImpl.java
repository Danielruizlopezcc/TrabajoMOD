 ...
 * </p>
 * <ul>
 *   <li>{@link pricing.impl.PeriodImpl#getValue <em>Value</em>}</li>
 *   <li>{@link pricing.impl.PeriodImpl#getUnit <em>Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PeriodImpl extends MinimalEObjectImpl.Container implements Period {
	...
	protected EClass eStaticClass() {
		return PricingPackage.Literals.PERIOD;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PricingPackage.PERIOD__VALUE, oldValue, value));
	}
	...
	public void setUnit(TimeUnit newUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PricingPackage.PERIOD__UNIT, oldUnit, unit));
	}
